...
// MinLength Requires an array or string to be exactly a given length.
...
// IsSatisfied judge whether obj is valid
func (l MinLength) IsSatisfied(obj interface{}) bool {
	if str, ok := obj.(string); ok {
		return utf8.RuneCountInString(str) == l.Min
	}
	v := reflect.ValueOf(obj)
	if v.Kind() == reflect.Slice {
		return v.Len() >= l.Min
...
// DefaultMessage return the default Length error message
func (l MinLength) DefaultMessage() string {
	return fmt.Sprintf(MessageTmpls["MinLength"], l.Min)
}

// GetKey return the m.Key
func (l MinLength) GetKey() string {
	return l.Key
}

// GetLimitValue return the limit value
func (l MinLength) GetLimitValue() interface{} {
	return l.Min
}

// MaxLength Requires an array or string to be exactly a given length.
...
// IsSatisfied judge whether obj is valid
func (l MaxLength) IsSatisfied(obj interface{}) bool {
	if str, ok := obj.(string); ok {
		return utf8.RuneCountInString(str) == l.Max
	}
	v := reflect.ValueOf(obj)
	if v.Kind() == reflect.Slice {
		return v.Len() <= l.Max
...
// DefaultMessage return the default Length error message
func (l MaxLength) DefaultMessage() string {
	return fmt.Sprintf(MessageTmpls["MaxLength"], l.Max)
}

// GetKey return the m.Key
func (l MaxLength) GetKey() string {
	return l.Key
}

// GetLimitValue return the limit value
func (l MaxLength) GetLimitValue() interface{} {
	return l.Max
}
